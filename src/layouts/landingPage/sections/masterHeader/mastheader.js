        ...
        <div className="container h-100">
            <div className="row h-100 align-items-center justify-content-center text-center">
                ...
                <div className="col-lg-8 align-self-baseline">
                    ...
                    <button className="btn btn-outline-success btn-xl loginbutton-user" href="#">User</button>
                    {/* <p className="text-white-50 font-weight-light mb-5">or</p> */}
                    <button className="btn btn-outline-primary btn-xl loginbutton-creator" href="#">Creator</button>
                    <p className="text-white font-weight-light mt-5">Already have an Account <button className="btn btn-primary btn-sm loginbutton">login</button></p>
                </div>
            </div>
        </div>
    </header>
